happn_ui_app.controller('new_object', ['$scope', '$modalInstance', 'dataService', function($scope, $modalInstance, dataService) {
	  ...
	  var checkPath = function(path){
	   ...
	   dataService.instance.get('/happn/templates/*', null, function(e, results){
           ...
           $scope.ok = function () {
				...
				if (okToSave){
					...
					dataService.instance.set($scope.data.path, $scope.data.data, null, function(e, result){
